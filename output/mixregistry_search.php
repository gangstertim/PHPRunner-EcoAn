...
include("include/mixregistry_variables.php");
...
$layout->blocks["top"][] = "search";$page_layouts["mixregistry_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "mixregistry_search.htm";
...
$params['shortTableName'] = 'mixregistry';
