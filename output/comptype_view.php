...
$layout->blocks["top"][] = "details";$page_layouts["comptype_view"] = $layout;
...
//CompTypeEng - 
	...
	if($mainTableOwnerID=="CompTypeEng")
		$ownerIdValue=$value;
	$xt->assign("CompTypeEng_value",$value);
...
//CompTypeLL - 
	...
	if($mainTableOwnerID=="CompTypeLL")
		$ownerIdValue=$value;
	$xt->assign("CompTypeLL_value",$value);
...
//DetailsEng - 
	...
	if($mainTableOwnerID=="DetailsEng")
		$ownerIdValue=$value;
	$xt->assign("DetailsEng_value",$value);
...
//detailsLL - 
	...
	if($mainTableOwnerID=="detailsLL")
		$ownerIdValue=$value;
	$xt->assign("detailsLL_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='comptype_edit.php?".$editlink."'\"");
