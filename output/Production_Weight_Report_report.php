...
$layout->blocks["top"][] = "hmenu";$page_layouts["Production_Weight_Report_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Production_Weight_Report_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Production_Weight_Report";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Production_Weight_Report_search.php';return false;\"");
