...
$layout->blocks["top"][] = "hmenu";$page_layouts["Price_List_Report_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Price_List_Report_report.php"
	</script>
	<?php
	}
	else
...
{
		$_SESSION[$sessionPrefix."_pagesize"] = 1;
}
...
$params['shortTName'] = "Price_List_Report";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Price_List_Report_search.php';return false;\"");
