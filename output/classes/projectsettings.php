...
function GetTableURL($table = "")
{
	...
	if("components" == $table) 
		return "components";
	if("componentusage" == $table) 
		return "componentusage";
	if("comptype" == $table) 
		return "comptype";
	if("costmodel" == $table) 
		return "costmodel";
	if("fixedassyuse" == $table) 
		return "fixedassyuse";
	if("fixedcomponents" == $table) 
		return "fixedcomponents";
	if("mix" == $table) 
		return "mix";
	if("mixregistry" == $table) 
		return "mixregistry";
	if("prodgrp" == $table) 
		return "prodgrp";
	if("productcolorcostjg" == $table) 
		return "productcolorcostjg";
	if("componenthistory" == $table) 
		return "componenthistory";
	if("producthistory" == $table) 
	...
	if("unittype" == $table) 
		return "unittype";
	if("Components Report" == $table) 
		return "Components_Report";
	if("Fixed Components Report" == $table) 
		return "Fixed_Components_Report";
	if("Product Group Prices Report" == $table) 
		return "Product_Group_Prices_Report";
	if("Input Products Report" == $table) 
		return "Input_Products_Report";
	if("Labor Rates By Group Report" == $table) 
		return "Labor_Rates_By_Group_Report";
	if("Mix Registry Report" == $table) 
		return "Mix_Registry_Report";
	if("Price List Report" == $table) 
		return "Price_List_Report";
	if("Production Weight Report" == $table) 
		return "Production_Weight_Report";
	if("prodcosts" == $table) 
		return "prodcosts";
	if("products Chart" == $table) 
...
{	
	...
	if(!$shortTName)
		return false;
	if("components" == $shortTName) 
		return "components";
	if("componentusage" == $shortTName) 
		return "componentusage";
	if("comptype" == $shortTName) 
		return "comptype";
	if("costmodel" == $shortTName) 
		return "costmodel";
	if("fixedassyuse" == $shortTName) 
		return "fixedassyuse";
	if("fixedcomponents" == $shortTName) 
		return "fixedcomponents";
	if("mix" == $shortTName) 
		return "mix";
	if("mixregistry" == $shortTName) 
		return "mixregistry";
	if("prodgrp" == $shortTName) 
		return "prodgrp";
	if("productcolorcostjg" == $shortTName) 
		return "productcolorcostjg";
	if("componenthistory" == $shortTName) 
		return "componenthistory";
	if("producthistory" == $shortTName) 
		return "producthistory";
	if("products" == $shortTName) 
		return "products";
	if("status" == $shortTName) 
		return "status";
	if("variables" == $shortTName) 
		return "variables";
	if("units" == $shortTName) 
		return "units";
	if("unittype" == $shortTName) 
		return "unittype";
	if("Components_Report" == $shortTName) 
		return "Components Report";
	if("Fixed_Components_Report" == $shortTName) 
		return "Fixed Components Report";
	if("Product_Group_Prices_Report" == $shortTName) 
		return "Product Group Prices Report";
	if("Input_Products_Report" == $shortTName) 
		return "Input Products Report";
	if("Labor_Rates_By_Group_Report" == $shortTName) 
		return "Labor Rates By Group Report";
	if("Mix_Registry_Report" == $shortTName) 
		return "Mix Registry Report";
	if("Price_List_Report" == $shortTName) 
		return "Price List Report";
	if("Production_Weight_Report" == $shortTName) 
		return "Production Weight Report";
	if("prodcosts" == $shortTName) 
		return "prodcosts";
	if("products_Chart" == $shortTName) 
		return "products Chart";
	if("buckets" == $shortTName) 
		return "buckets";
}
