...
$layout->blocks["top"][] = "grid";$page_layouts["Mix_Registry_Report_rprint"] = $layout;
...
$params["templatefile"] = "Mix_Registry_Report_rprint.htm";
$params["xt"] = &$xt;
...
if (@$_REQUEST["format"]=="excel")
{
	...
	header("Content-Disposition: attachment;Filename=Mix_Registry_Report.xls");
...
else if (@$_REQUEST["format"]=="word")
{
	...
	header("Content-Disposition: attachment;Filename=Mix_Registry_Report.doc");
	echo "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=".$cCharset."\">";
}
