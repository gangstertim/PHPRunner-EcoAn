...
$layout->blocks["top"][] = "details";$page_layouts["units_view"] = $layout;
...
//Unit_LL - 
	...
	if($mainTableOwnerID=="Unit_LL")
		$ownerIdValue=$value;
	$xt->assign("Unit_LL_value",$value);
...
//Unit_English_Full - 
	...
	if($mainTableOwnerID=="Unit_English_Full")
		$ownerIdValue=$value;
	$xt->assign("Unit_English_Full_value",$value);
...
//Unit_LL_Full - 
	...
	if($mainTableOwnerID=="Unit_LL_Full")
		$ownerIdValue=$value;
	$xt->assign("Unit_LL_Full_value",$value);
...
//Rel_to_Base - Number
	...
	if($mainTableOwnerID=="Rel_to_Base")
		$ownerIdValue=$value;
	$xt->assign("Rel_to_Base_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='units_edit.php?".$editlink."'\"");
