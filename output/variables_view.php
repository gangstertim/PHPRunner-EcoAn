...
$layout->blocks["top"][] = "details";$page_layouts["variables_view"] = $layout;
...
$arr = array();
$arr['fName'] = "ProdGrp";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("ProdGrp");
$fieldsArr[] = $arr;
...
//ProdGrp - 
	...
	if($mainTableOwnerID=="ProdGrp")
		$ownerIdValue=$value;
	$xt->assign("ProdGrp_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='variables_edit.php?".$editlink."'\"");
