...
// keys array
$keys[]=AddFieldWrappers("ComponentNo");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("ComponentNo",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["components_import"] = $layout;
...
$xt->display("components_import.htm");
