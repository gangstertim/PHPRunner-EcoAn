...
$layout->blocks["top"][] = "pdf";$page_layouts["mix_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "UnitOrBucket";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("UnitOrBucket");
$fieldsArr[] = $arr;
...
//	UnitOrBucket - 
			$record["UnitOrBucket_value"] = $pageObject->showDBValue("UnitOrBucket", $data, $keylink);
			$record["UnitOrBucket_class"] = $pageObject->fieldClass("UnitOrBucket");
			if($col<$colsonpage)
...
$xt->assign("UnitOrBucket_fieldheadercolumn",true);
$xt->assign("UnitOrBucket_fieldheader",true);
$xt->assign("UnitOrBucket_fieldcolumn",true);
$xt->assign("UnitOrBucket_fieldfootercolumn",true);
