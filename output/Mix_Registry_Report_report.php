...
$layout->blocks["top"][] = "hmenu";$page_layouts["Mix_Registry_Report_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Mix_Registry_Report_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Mix_Registry_Report";
...
$fieldArr = array();
$fieldArr['name'] = "MixColor";
//'fName' added for maps
$fieldArr['fName'] = "MixColor";
$fieldArr['label'] = "Mix Color";
$fieldArr['goodName'] = "MixColor";
$fieldArr['repPage'] = "0";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$fieldArr['name'] = "Notes";
//'fName' added for maps
$fieldArr['fName'] = "Notes";
$fieldArr['label'] = "Notes";
$fieldArr['goodName'] = "Notes";
$fieldArr['repPage'] = "0";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Mix_Registry_Report_search.php';return false;\"");
