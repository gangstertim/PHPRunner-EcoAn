...
$layout->blocks["top"][] = "search";$page_layouts["comptype_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "comptype_search.htm";
...
$params['shortTableName'] = 'comptype';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("DetailsEng"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("DetailsEng")] = GetTableURL($pageObject->pSet->getLookupTable("DetailsEng"));
	
	$pageObject->fillFieldToolTips("DetailsEng");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("DetailsEng");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "DetailsEng";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("DetailsEng_label","<label for=\"".GetInputElementId("DetailsEng", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("DetailsEng_label", true);
	
	$xt->assign("DetailsEng_fieldblock", true);
	$xt->assignbyref("DetailsEng_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("DetailsEng_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("DetailsEng_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_DetailsEng", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("DetailsEng");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"DetailsEng", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"DetailsEng", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	
	if($pageObject->pSet->getLookupTable("detailsLL"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("detailsLL")] = GetTableURL($pageObject->pSet->getLookupTable("detailsLL"));
	
	$pageObject->fillFieldToolTips("detailsLL");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("detailsLL");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "detailsLL";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("detailsLL_label","<label for=\"".GetInputElementId("detailsLL", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("detailsLL_label", true);
	
	$xt->assign("detailsLL_fieldblock", true);
	$xt->assignbyref("detailsLL_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("detailsLL_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("detailsLL_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_detailsLL", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("detailsLL");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"detailsLL", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"detailsLL", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
