...
include("include/Production_Weight_Report_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["Production_Weight_Report_export"] = $layout;
...
$xt->display("Production_Weight_Report_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=Production_Weight_Report.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Production_Weight_Report.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Production_Weight_Report.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Production_Weight_Report.csv");
