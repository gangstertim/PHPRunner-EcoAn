...
$strOriginalTableName="`comptype`";
CheckPermissionsEvent($strTableName, 'I');

$cipherer = new RunnerCipherer($strTableName);

// keys array
$keys[]=AddFieldWrappers("CompTypeNo");
$keys_present=1;
...
$layout->blocks["top"][] = "import";$page_layouts["comptype_import"] = $layout;
...
$xt->display("comptype_import.htm");
