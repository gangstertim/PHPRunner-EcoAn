...
$layout->blocks["top"][] = "hmenu";$page_layouts["Product_Group_Prices_Report_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Product_Group_Prices_Report_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Product_Group_Prices_Report";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Product_Group_Prices_Report_search.php';return false;\"");
