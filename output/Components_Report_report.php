...
$layout->blocks["top"][] = "hmenu";$page_layouts["Components_Report_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Components_Report_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Components_Report";
...
$fieldArr = array();
$fieldArr['name'] = "CompTypeEng";
//'fName' added for maps
$fieldArr['fName'] = "CompTypeEng";
$fieldArr['label'] = "Comp Type Eng";
$fieldArr['goodName'] = "CompTypeEng";
$fieldArr['repPage'] = "0";
...
$fieldArr = array();
$fieldArr['name'] = "CompTypeLL";
//'fName' added for maps
$fieldArr['fName'] = "CompTypeLL";
$fieldArr['label'] = "Comp Type LL";
$fieldArr['goodName'] = "CompTypeLL";
$fieldArr['repPage'] = "0";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "CompPurchaseUnitEn";
//'fName' added for maps
$fieldArr['fName'] = "CompPurchaseUnitEn";
$fieldArr['label'] = "Comp Purchase Unit En";
$fieldArr['goodName'] = "CompPurchaseUnitEn";
$fieldArr['repPage'] = "0";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "UnitQty";
//'fName' added for maps
$fieldArr['fName'] = "UnitQty";
$fieldArr['label'] = "Unit Qty";
$fieldArr['goodName'] = "UnitQty";
$fieldArr['repPage'] = "0";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "Density";
//'fName' added for maps
$fieldArr['fName'] = "Density";
$fieldArr['label'] = "Density";
$fieldArr['goodName'] = "Density";
$fieldArr['repPage'] = "0";
$fieldArr['viewFormat'] = "Number";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "Unit_LL";
//'fName' added for maps
$fieldArr['fName'] = "Unit_LL";
$fieldArr['label'] = "Unit LL";
$fieldArr['goodName'] = "Unit_LL";
$fieldArr['repPage'] = "0";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Components_Report_search.php';return false;\"");
