...
include("include/fixedcomponents_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["fixedcomponents_export"] = $layout;
...
$xt->display("fixedcomponents_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=fixedcomponents.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=fixedcomponents.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=fixedcomponents.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=fixedcomponents.csv");
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Thainame").'</td>';	
