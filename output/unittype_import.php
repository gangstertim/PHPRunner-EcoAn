...
$strOriginalTableName="`unittype`";
CheckPermissionsEvent($strTableName, 'I');

$cipherer = new RunnerCipherer($strTableName);

// keys array
$keys[]=AddFieldWrappers("Unit_Type_English");
$keys_present=1;
...
$layout = new TLayout("import","FancyGreen1","MobileGreen1");
...
$layout->blocks["top"][] = "import";$page_layouts["unittype_import"] = $layout;
...
$xt->display("unittype_import.htm");
