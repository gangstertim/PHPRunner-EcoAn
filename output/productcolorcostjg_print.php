...
$layout->blocks["top"][] = "pdf";$page_layouts["productcolorcostjg_print"] = $layout;
...
$fieldsArr = array();
$arr = array();
$arr['fName'] = "ProductColor";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("ProductColor");
$fieldsArr[] = $arr;
$arr = array();
...
$arr = array();
$arr['fName'] = "Cost4";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("Cost4");
$fieldsArr[] = $arr;
...
//	ProductColor - 
			$record["ProductColor_value"] = $pageObject->showDBValue("ProductColor", $data, $keylink);
			$record["ProductColor_class"] = $pageObject->fieldClass("ProductColor");
//	ProdGrpCode - 
...
//	Cost4 - Number
			$record["Cost4_value"] = $pageObject->showDBValue("Cost4", $data, $keylink);
			$record["Cost4_class"] = $pageObject->fieldClass("Cost4");
			if($col<$colsonpage)
...
$xt->assign("ProductColor_fieldheadercolumn",true);
$xt->assign("ProductColor_fieldheader",true);
$xt->assign("ProductColor_fieldcolumn",true);
$xt->assign("ProductColor_fieldfootercolumn",true);
...
$xt->assign("Cost4_fieldheadercolumn",true);
$xt->assign("Cost4_fieldheader",true);
$xt->assign("Cost4_fieldcolumn",true);
$xt->assign("Cost4_fieldfootercolumn",true);
