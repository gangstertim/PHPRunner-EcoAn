...
include("include/fixedassyuse_variables.php");
...
$layout->blocks["top"][] = "export";$page_layouts["fixedassyuse_export"] = $layout;
...
$xt->display("fixedassyuse_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=fixedassyuse.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=fixedassyuse.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=fixedassyuse.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=fixedassyuse.csv");
