...
$layout->blocks["top"][] = "pdf";$page_layouts["mixregistry_print"] = $layout;
...
$arr = array();
$arr['fName'] = "MixColor";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("MixColor");
$fieldsArr[] = $arr;
$arr = array();
...
//	MixColor - 
			$record["MixColor_value"] = $pageObject->showDBValue("MixColor", $data, $keylink);
			$record["MixColor_class"] = $pageObject->fieldClass("MixColor");
//	ProdGrpCode - 
...
$xt->assign("MixColor_fieldheadercolumn",true);
$xt->assign("MixColor_fieldheader",true);
$xt->assign("MixColor_fieldcolumn",true);
$xt->assign("MixColor_fieldfootercolumn",true);
