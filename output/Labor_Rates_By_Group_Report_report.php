...
$layout->blocks["top"][] = "hmenu";$page_layouts["Labor_Rates_By_Group_Report_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Labor_Rates_By_Group_Report_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Labor_Rates_By_Group_Report";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Labor_Rates_By_Group_Report_search.php';return false;\"");
