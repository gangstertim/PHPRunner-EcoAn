...
$layout->blocks["top"][] = "pdf";$page_layouts["products_print"] = $layout;
...
//	MoldWt - Number
			$record["MoldWt_value"] = $pageObject->showDBValue("MoldWt", $data, $keylink);
			$record["MoldWt_class"] = $pageObject->fieldClass("MoldWt");
//	GrayWtMold - Number
			$record["GrayWtMold_value"] = $pageObject->showDBValue("GrayWtMold", $data, $keylink);
			$record["GrayWtMold_class"] = $pageObject->fieldClass("GrayWtMold");
//	ColorWtMold - Number
			$record["ColorWtMold_value"] = $pageObject->showDBValue("ColorWtMold", $data, $keylink);
			$record["ColorWtMold_class"] = $pageObject->fieldClass("ColorWtMold");
//	Length - Number
			$record["Length_value"] = $pageObject->showDBValue("Length", $data, $keylink);
			$record["Length_class"] = $pageObject->fieldClass("Length");
//	Width1 - Number
			$record["Width1_value"] = $pageObject->showDBValue("Width1", $data, $keylink);
			$record["Width1_class"] = $pageObject->fieldClass("Width1");
//	Thickness - Number
			$record["Thickness_value"] = $pageObject->showDBValue("Thickness", $data, $keylink);
			$record["Thickness_class"] = $pageObject->fieldClass("Thickness");
//	ProdNo - 
...
$xt->assign("MoldWt_fieldheadercolumn",true);
$xt->assign("MoldWt_fieldheader",true);
$xt->assign("MoldWt_fieldcolumn",true);
$xt->assign("MoldWt_fieldfootercolumn",true);
$xt->assign("GrayWtMold_fieldheadercolumn",true);
$xt->assign("GrayWtMold_fieldheader",true);
$xt->assign("GrayWtMold_fieldcolumn",true);
$xt->assign("GrayWtMold_fieldfootercolumn",true);
$xt->assign("ColorWtMold_fieldheadercolumn",true);
$xt->assign("ColorWtMold_fieldheader",true);
$xt->assign("ColorWtMold_fieldcolumn",true);
$xt->assign("ColorWtMold_fieldfootercolumn",true);
$xt->assign("Length_fieldheadercolumn",true);
$xt->assign("Length_fieldheader",true);
$xt->assign("Length_fieldcolumn",true);
$xt->assign("Length_fieldfootercolumn",true);
$xt->assign("Width1_fieldheadercolumn",true);
$xt->assign("Width1_fieldheader",true);
$xt->assign("Width1_fieldcolumn",true);
$xt->assign("Width1_fieldfootercolumn",true);
$xt->assign("Thickness_fieldheadercolumn",true);
$xt->assign("Thickness_fieldheader",true);
$xt->assign("Thickness_fieldcolumn",true);
$xt->assign("Thickness_fieldfootercolumn",true);
