...
function checkTableName($shortTName, $type=false)
{
	...
	if ("components" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("componentusage" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("comptype" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("costmodel" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("fixedassyuse" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("fixedcomponents" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("mix" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("mixregistry" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("prodgrp" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("productcolorcostjg" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("componenthistory" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("producthistory" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("products" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("status" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("variables" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("units" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("unittype" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("Components_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Fixed_Components_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Product_Group_Prices_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Input_Products_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Labor_Rates_By_Group_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Mix_Registry_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Price_List_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("Production_Weight_Report" == $shortTName && ($type===false || ($type!==false && $type == 2)))
		return true;
	if ("prodcosts" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("products_Chart" == $shortTName && ($type===false || ($type!==false && $type == 3)))
		return true;
	if ("buckets" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	$arr = array();
		...
		$arr[]="mixregistry";
		$arr[]="prodgrp";
		$arr[]="productcolorcostjg";
		$arr[]="componenthistory";
		$arr[]="producthistory";
		$arr[]="products";
		$arr[]="status";
		$arr[]="variables";
		$arr[]="units";
		$arr[]="unittype";
		$arr[]="Components Report";
		$arr[]="Fixed Components Report";
		$arr[]="Product Group Prices Report";
		$arr[]="Input Products Report";
		$arr[]="Labor Rates By Group Report";
		$arr[]="Mix Registry Report";
		$arr[]="Price List Report";
		$arr[]="Production Weight Report";
		$arr[]="prodcosts";
		$arr[]="products Chart";
		$arr[]="buckets";
	return $arr;
...
function GetUserPermissions($table="")
{
	...
	if($table=="fixedassyuse")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="fixedcomponents")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="mix")
	...
	if($table=="productcolorcostjg")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="componenthistory")
	{
			$permissions =  "ADESPIM";
	}
	...
	if($table=="Components Report")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="Fixed Components Report")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="Product Group Prices Report")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="Input Products Report")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="Labor Rates By Group Report")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="Mix Registry Report")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="Price List Report")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="Production Weight Report")
	{
			$permissions =  "ADESPIM";
	}
	if($table=="prodcosts")
