...
$layout->blocks["top"][] = "export";$page_layouts["Mix_Registry_Report_export"] = $layout;
...
$xt->display("Mix_Registry_Report_export.htm");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Mix_Registry_Report.xml");
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=Mix_Registry_Report.csv");
