...
$layout->blocks["top"][] = "hmenu";$page_layouts["Input_Products_Report_report"] = $layout;
...
if(!postvalue("crosstable_refresh"))
{
	...
	?>
	<script>
	var report_filename="Input_Products_Report_report.php"
	</script>
	<?php
	}
	else
...
$params['shortTName'] = "Input_Products_Report";
...
$params['fieldsArr'][] = $fieldArr;
$fieldArr = array();
$fieldArr['name'] = "UnitThaiRpt";
//'fName' added for maps
$fieldArr['fName'] = "UnitThaiRpt";
$fieldArr['label'] = "Unit Thai Rpt";
$fieldArr['goodName'] = "UnitThaiRpt";
$fieldArr['repPage'] = "0";
$fieldArr['editFormat'] = "Text field";
$fieldArr['thumbnail'] = "th";
$fieldArr['fileName'] = "";
...
$xt->assign("asearchlink_attrs","id=\"asearch_".$id."\" name=\"asearch_".$id."\" onclick=\"window.location.href='Input_Products_Report_search.php';return false;\"");
